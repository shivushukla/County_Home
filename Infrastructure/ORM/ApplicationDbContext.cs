...
namespace Infrastructure.ORM
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public ApplicationDbContext(DbContextOptions options, IDependencyProvider dependencyProvider, string connectionString) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            ConfigureTypesWithNoAutoGeneratedID(modelBuilder, typeof(Lookup), typeof(LookupType), typeof(City), typeof(Country), typeof(State), typeof(Zip), typeof(UserLogin), typeof(Feature), typeof(RoleFeature));
